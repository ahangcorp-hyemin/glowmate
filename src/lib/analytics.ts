...
type EventName =
  | "cta_estimate_click" | "review_start" | "visit_start" | "preset_question_click"
  | "ledger_add" | "ledger_banner_click" | "cohort_dist_view"
  | "quote_request_submit" | "quote_result_open" | "quote_connect_click";
