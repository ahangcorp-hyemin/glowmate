...
const POINTS: [string, string, string][] = [
  ["sparkle", "40·50대만 모이는 곳", "노화·리프팅 고민의 4050이 '알고 가려고' 들어옵니다. 이벤트 헌터가 아니라 상담 의사가 있는 환자군이에요."],
  ["pin", "광고 순위 없는 노출", "전국 2,791개 피부과·성형외과가 거리순으로 공정하게 노출됩니다. 병원 상세·전화·길찾기 연결까지 기본 제공."],
  ["🧾", "건당 수수료 0원", "예약·시술 건당 수수료를 받지 않습니다(의료법 §27 준수). 광고는 정액 노출만, 견적·후기 순위에 영향을 주지 않아요."],
  ["book", "정보로 신뢰를 먼저", "시술 레슨·출처 있는 답변으로 환자가 '알고' 옵니다. 상담 시간이 설명이 아니라 결정에 쓰여요."],
];
